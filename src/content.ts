...
export const professionalExperience: EvidenceItem[] = [
  { id: 'atlantic-city', title: 'Ingeniería de software en entorno regulado', organization: 'Atlantic City Casino & Sports', label: 'Experiencia profesional actual', summary: 'Software engineering en un entorno empresarial regulado, con trabajo en arquitectura de software, cloud y datos, hardening de aplicaciones y evolución del SDLC.', tags: ['Enterprise Software', 'Cloud / Data', 'Secure SDLC'] },
  { id: 'caja-metropolitana', title: 'Backend e integración en banca regulada', organization: 'Caja Metropolitana de Lima', label: 'Experiencia profesional', summary: 'Backend, arquitectura e integraciones para sistemas financieros: APIs seguras, HSM, transferencias inmediatas, autenticación biométrica, resiliencia y continuidad.', tags: ['.NET', 'APIs', 'HSM', 'Distributed Systems', 'Security'] },

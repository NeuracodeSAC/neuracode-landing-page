...
const banned = [/Jack de NeuraCode/i,/Egresado UNI/i,/fundad[ao].*20(?:20|24)/i,/25 de marzo/i,/1 abril/i,/8 abril/i,/10x/i,/93%/,/Medina Cuba Plumbing/i,/Hola Mujer/i,/\bSEAL\b/,/Megalíneas/i,/Sin fecha confirmada/i]
let failed = false

...
const pages = {
  ...
  '/empresas': ['Consultoría de IA y Automatización para Empresas | Neuracode','Discovery, pilotos e implementación de automatización, agentes y sistemas de IA. Claude, OpenAI/Codex, AWS Bedrock, datos, APIs y Secure SDLC.'],
  ...
  '/jack-aguilar': ['Jack Aguilar | Consultor de IA, Automatización y Agentes','Ingeniero de software y consultor en IA. Diseño automatizaciones, agentes y sistemas con LLMs, datos y APIs para empresas. Claude, OpenAI/Codex y AWS Bedrock.'],
